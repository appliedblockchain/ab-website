...
export const projects: Project[] = [
  ...
  },
  {
    ...
    type: '',
    link: 'https://wyzepay.com/',
  },
  {
    title: 'United Nations',
    subtitle:
      'Working with the United Nations agencies including World Food Program and UNICEF',
    description:
  ...
  },
  {
    title: 'Emsurge',
    subtitle:
      'Streamlining the pre to post trade process and create more interactive, efficient LNG networks',
    description:
